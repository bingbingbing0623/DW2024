...
export default {
  ...
  methods: {
    ...
    getNewPage(form) {
      ...
      if (form.source == "actor"&&this.isTopRating==false) {
        //neo4j关系查询
        this.$axios
          .get("/neo4j/actors/frequent-actors", {
            params: {
          ...
          .then((res) => {
            console.log(res);
            this.result=res.collaborations;
            this.neo4j_speed = res.time;
            this.isLoading = false;
          })
          .catch((err) => {
      ...
      else if (form.source == "director"&&this.isTopRating==false) {
        this.$axios
          .get("/neo4j/actors/frequent-directors", {
            params: {
              page: this.currentPage,
      ...
      else if (form.source == "actor"&&this.isTopRating==true) {
        //neo4j关系查询
        this.$axios
          .get("/neo4j/actors/toprating", {
            params: {
      ...
      else if (form.source == "director"&&this.isTopRating==true) {
        this.$message.warning("口碑查找不支持导演!");
      }
